...
const PageLayout = ({ user }) => {
  const [bgImageUrl, setBgImageUrl] = useState(user?.PageLayout?.bgImage || "https://images.pexels.com/photos/169677/pexels-photo-169677.jpeg")
  ...
  return (
    <div className="w-[90%] mx-auto py-6 mt-2 space-y-6 text-zinc-800 dark:text-zinc-100">
      ...
      <div className="max-h-[70vh] w-full transform translate-2 transition-transform">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
              {queryImages.map((image, i) => (
                <div
                  ...
                  onClick={() => setBgImageUrl(image.url)}
                >
                  <Image
